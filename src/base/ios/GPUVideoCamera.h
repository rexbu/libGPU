...
@protocol GPUCameraSampleDelegate<NSObject>
...
@interface GPUVideoCamera : GPUVideoFrame<AVCaptureVideoDataOutputSampleBufferDelegate, AVCaptureAudioDataOutputSampleBufferDelegate>
